...
output_file = "data/processed_IIT_HW_Hindi_v1/filtered/filtered_sorted_train.txt"


with open(input_file, "r", encoding="utf-8") as f:
    lines = f.readlines()

filtered_lines = [line.strip() for line in lines if line.startswith("HindiSeg/train/1/")]
